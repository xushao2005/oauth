...
public class ArithUtil { 
	...
	*/ 
	...
	//默认金额格式化
	private static final DecimalFormat PRICE_FORMAT = new DecimalFormat("#.0000");
	...
	*/ 
	...
	public static String format(String str){
		...
		return PRICE_FORMAT.format(b);
	}
	
	public static BigDecimal g2kg(String g){
		BigDecimal kg = null;
		if(StringUtils.isNumeric(g)){
			kg = new BigDecimal(g).divide(new BigDecimal("1000"));
		}else{
			kg = new BigDecimal("0");
		}
		return kg;
	...
	public static BigDecimal g2kg(Integer g){
		BigDecimal kg = null;
		if(g==null || g==0){
			kg = new BigDecimal("0");
		}else{
