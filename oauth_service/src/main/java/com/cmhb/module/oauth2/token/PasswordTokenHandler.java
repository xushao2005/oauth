...
import com.cmhb.module.oauth2.validator.PasswordClientDetailsValidator;
...
public class PasswordTokenHandler extends AbstractOAuthTokenHandler {
    ...
    public void handleAfterValidation() throws OAuthProblemException, OAuthSystemException {
        ...
        AccessToken accessToken = accessTokenService.retrieveAccessToken(clientDetails(), tokenRequest.getUsername());
