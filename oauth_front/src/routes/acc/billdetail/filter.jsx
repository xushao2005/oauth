...
import * as billdetailService from "../../../services/acc/billdetail"

const {RangePicker} = DatePicker
const DateFormat = "YYYY-MM-DD"
const AOption = AutoComplete.Option
const FilterContent = ({dispatch, form, transbill, selectProduct, onFilterChange}) => {
	...
	const handleFields = (fields) => {
		...
		fields.mainNo = transbill.mainNo
		fields.transType = transbill.transType
	...
	const handleExport = () => {
		validateFieldsAndScroll((err) => {
			if (!err) {
				const fields = getFieldsValue()
				const params = handleFields(fields)
				billdetailService.exp(params).then((data) => {
